<x-app-layout>
    <div class="max-w-4xl mx-auto bg-gray-800 p-8 rounded-lg shadow-lg mt-10 text-white mb-10">
        <h1 class="text-3xl font-bold mb-6 text-center">Crear Horario</h1>
        ...
        <form action="{{ route('horarios.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="date" name="fecha" id="fecha" class="w-full mt-1 p-2 bg-gray-700 text-white rounded border border-gray-600 focus:outline-none focus:ring focus:ring-blue-500" required>
            </div>

            <!-- Hora de Inicio -->
            <div class="mb-4">
                <label for="hora_inicio" class="block text-lg font-medium">Hora de Inicio *</label>
                <input type="time" name="hora_inicio" id="hora_inicio" class="w-full mt-1 p-2 bg-gray-700 text-white rounded border border-gray-600 focus:outline-none focus:ring focus:ring-blue-500" required>
            </div>

            <!-- Hora de Fin -->
            <div class="mb-4">
                <label for="hora_fin" class="block text-lg font-medium">Hora de Fin *</label>
                <input type="time" name="hora_fin" id="hora_fin" class="w-full mt-1 p-2 bg-gray-700 text-white rounded border border-gray-600 focus:outline-none focus:ring focus:ring-blue-500" required>
            </div>
